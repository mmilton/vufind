...
class Zend2 extends EdsApi_REST_Base
{
	 ...
	 *
	 * @param array  $settings Associative array of setting to use in conjunction with the EDS API
	 *    <ul>
	 *      <li>debug - boolean to control debug mode</li>
	 *      <li>authtoken - Authentication to use for calls to the API. If using IP Authentication, this is not needed.</li>
	 *      <li>username -  EBSCO username for account setup for usage with the EDS API. This is only required for institutions using UID Authentication </li>
	 *      <li>password - EBSCO password for account setup for usage with the EDS API. This is only required for institutions using UID Authentication </li>
	 *      <li>orgid - Organization making calls to the EDS API </li>
	 *      <li>sessiontoken - SessionToken this call is associated with, is one exists. If not, the a profile value must be present </li>
	 *     	<li>profile - EBSCO profile to use for calls to the API. </li>
	 *      <li>isguest - is the user a guest. This needs to be present if there is no session token present</li>
	 *    </ul>
